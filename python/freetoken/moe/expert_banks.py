...
banks from them (``build_expert_banks``). Native GGUF experts still use
their own providers until they get a method.
"""
...
def load_expert_banks(
    ...
    * **Slow path** (the original checkpoint): auto-pick **parallel** (the common parallel chunked
    ...
    legacy native-GGUF formats load, through their own providers.
